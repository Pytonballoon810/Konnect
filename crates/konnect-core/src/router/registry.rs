...
pub static ALL_TOOLSETS: &[ToolsetMeta] = &[
    ToolsetMeta {
        name: "project",
        description: "Create, open, save, snapshot KiCAD projects, launch the live schematic viewer, and keep open views in step with what is written",
        category: "project",
        tool_count: 9,
    },
    ToolsetMeta {
    ...
    ToolsetMeta {
        name: "pcb_board",
        description: "Board outline, layers, zones, mounting holes, board text, SVG logo import, update PCB from schematic (F8)",
        category: "pcb",
        tool_count: 12,
    },
    ToolsetMeta {
